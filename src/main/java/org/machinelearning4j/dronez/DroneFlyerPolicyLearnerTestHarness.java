...
public class DroneFlyerPolicyLearnerTestHarness extends AbstractDroneFlyer{
	...
	public DroneFlyerPolicyLearnerTestHarness(Drone drone,
	...
	public static void main(String[] args) {
		...
		if (useMocks)
		{
			...
			// Fly
			DroneFlyerPolicyLearnerTestHarness droneFlyer = new DroneFlyerPolicyLearnerTestHarness(drone,webCamObserver,commandFactory);
			droneFlyer.flyDrone();
		}
		else
		{
