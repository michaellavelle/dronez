...
public class MockDrone extends Drone {
	...
	public MockDrone(MockWebCamObserver mockWebCamObserver, Model<DroneState, DroneState, DroneAction> droneModel,
			int actionDelayIterations, int actionMillisecondInterval) {
