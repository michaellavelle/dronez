	...
	public DroneState getCurrentState() {
		...
		if (position != null && velocity != null) {
			...
			return new DroneState(new PositionVelocity(getLeftRightPosition(position), velocity.getLeftRightVel()),
					new PositionVelocity(getUpDownPosition(position), velocity.getUpDownVel()), new PositionVelocity(
							getForwardBackPosition(position), velocity.getForwardVel()), new PositionVelocity(
							this.getSpinPosition(position), this.getSpinVelocity()));
		} else {
			return null;
		}
	}
