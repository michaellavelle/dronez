...
public class RelativePositionVelocityIndexMapper implements IndexMapper<TargetRelativePositionWithVelocity>,
		Serializable {
	...
	public TargetRelativePositionWithVelocity[] getIndexedValues() {
		...
		TargetRelativePositionWithVelocity[] indexedValues = new TargetRelativePositionWithVelocity[velocities.length
				* positions.length];
		int index = 0;
