...
public class IndependentDimensionsTargetTrajectoryPolicy implements
	...
	public DroneAction getAction(TargetRelativeDroneStateWithRecentActions droneState) {
		...
		LeftRightAction leftRightAction = leftRightTargetTrajectoryPolicy.getAction(droneState
		...
		ForwardBackAction forwardBackAction = forwardBackTargetTrajectoryPolicy.getAction(droneState
				.getForwardBackPositionVelocity());
